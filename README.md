...
Built for people whose whole skill floor is *scan, upload, download*. You should never have to see the words bucket, key, schema or encryption unless you go looking.
...
- **A household, not a user.** Members with or without their own sign-in (children, elderly parents), four simple roles, and three plain visibility levels per document: *Everyone in the family*, *Adults only*, *Only me*.
...
*Arrives with the first runnable release.* It will be:
...
*Documented with the first release that ships the export and backup jobs.* The shape of it:
